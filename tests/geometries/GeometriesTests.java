...
class GeometriesTests {
    ...
    void findIntersections() {
        ...
        Triangle triangle = new Triangle(new Point3D(0, 2, 0), new Point3D(2, 2, 0), new Point3D(1.5, 2, 2));
        ...
        Ray rayAllObjectIntersect = new Ray(new Point3D(1, 2.5, 1), new Vector(0, -1, 0));
