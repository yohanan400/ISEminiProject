...
//        render.writeToImage();
        ...
        Camera camera = new Camera(new Point3D(0, 0, 2000), new Vector(0, 1, 0), new Vector(0, 0, -1)) //
                ...
                .setApertureRadiusSize(16)
                .setFocalDistance(new Point3D(0, 0, 2000).distance(new Point3D(-60, -50, 100)));
        ...
        scene._geometries.add( //
                ...
                new Sphere(new Point3D(-60, 0, 100), 20) //
                        .setEmission(new Color(java.awt.Color.red)) //
                        .setMaterial(new Material().setKd(0.002).setKs(0.2).setNShininess(30)),
